...
/**
 * copy @https://github.com/BCsl/GalleryLayoutManager
 * 为何不直接使用
 * 因为发现直接使用gradle 下载后
 * 打包出来大了2m
 * */

public class CWCureLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    private static final String TAG = "CWCureLayoutManager";
    ...
    public CWCureLayoutManager(int orientation) {
    ...
    public RecyclerView.LayoutParams generateDefaultLayoutParams() {
        if (mOrientation == VERTICAL) {
            return new CWCureLayoutManager.LayoutParams(
    ...
    /**
     * Layout the item view witch position specified by {@link CWCureLayoutManager#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    /**
     * Layout the item view witch position special by {@link CWCureLayoutManager#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    private float calculateToCenterFraction(View child, float pendingOffset) {
        ...
        int childLength = mOrientation == CWCureLayoutManager.HORIZONTAL ? child.getWidth() : child.getHeight();
    ...
    private int calculateDistanceCenter(View child, float pendingOffset) {
        ...
        if (mOrientation == CWCureLayoutManager.HORIZONTAL) {
    ...
    public interface ItemTransformer {
         ...
         */
        void transformItem(CWCureLayoutManager layoutManager, View item, float fraction);
    }
    ...
    /**
     * Implement to support {@link CWCureLayoutManager#smoothScrollToPosition(RecyclerView, RecyclerView.State, int)}
     */
